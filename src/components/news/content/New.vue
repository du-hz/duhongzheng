<template>
  <div>
    ...
    <div class="main-line-title">{{id === '' ? '创建新闻' : '编辑新闻'}}</div>
    <el-form ref="form" :model="form" label-width="80px" style="width: 70%">
      ...
      <el-form-item label="外部链接">
        <el-input v-model="form.externalLink" placeholder="如填写，则本条新闻直接跳转到外部链接地址"></el-input>
      </el-form-item>
      <el-form-item label="描述">
        <el-input type="textarea" :rows="5" v-model="form.description" maxlength="100" placeholder="不超过100个字符"></el-input>
      </el-form-item>
      <el-form-item label="所属频道">
        <el-select placeholder="请选择新闻所属频道" v-model="form.newsTypeId" style="width: 100%">
          <el-option
      ...
      <el-form-item label="是否推荐">
        <el-radio-group v-model="form.recommendStatus">
          ...
          <el-radio :label="1">推荐到今日热点频道</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item>
  ...
  methods: {
    ...
    saveOperate () {
      ...
      if (_vue.id === '' || _vue.id === null) {
        // 新增新闻
        _vue.$http.post('/api/v1.0/news/content/add_news', {
          ...
          newsTypeId: _vue.form.newsTypeId,
          recommendStatus: _vue.form.recommendStatus + '',
          externalLink: _vue.form.externalLink,
          headImgType: _vue.coverImageRadio
        }).then(() => {
          _vue.$message({
            type: 'success',
            message: '保存成功',
        ...
        // 编辑新闻
        _vue.$http.put('/api/v1.0/news/content/edit', {
          id: _vue.id,
          title: _vue.form.title,
          content: _vue.editor.getData() || '',
          description: _vue.form.description,
